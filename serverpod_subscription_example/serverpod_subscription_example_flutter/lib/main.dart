...
import 'package:serverpod_subscription_example_client/serverpod_subscription_example_client.dart';
...
import 'package:serverpod_subscription_example_flutter/consumables_store.dart';
...
const userIdentifier = "tyler@tylersavery.com";

final bool _kAutoConsume = Platform.isIOS || true;

const String _kConsumableId = 'consumable';
const String _kProMonthly = 'serverpodsubpro';
const String _kProAnnual = 'serverpodsubproannual';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Serverpod Subscription Example',
      theme: ThemeData(
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    if (userInfo != null) {
      return Scaffold(
        appBar: AppBar(
          title: Text("Welcome ${userInfo!.userName ?? 'user'}!"),
          actions: [
            IconButton(
              onPressed: () {
        ...
        body: const Center(
          child: CreateSubscriptionWidget(),
        ),
      );
    }
...
class CreateSubscriptionWidget extends StatefulWidget {
  ...
  @override
  State<CreateSubscriptionWidget> createState() => _CreateSubscriptionWidgetState();
}
...
class _CreateSubscriptionWidgetState extends State<CreateSubscriptionWidget> {
  ...
  Future<bool> _verifyPurchase(PurchaseDetails purchaseDetails) async {
    final appPurchaseDetails = AppPurchaseDetails(
    ...
    final success = await client.modules.subscription.apple.handlePurchase(appPurchaseDetails);
    return success;
  }
                  ...
                  onPressed: () {
                    ...
                    if (Platform.isAndroid) {
                      ...
                      purchaseParam = GooglePlayPurchaseParam(
                          productDetails: productDetails,
                          applicationUserName: userIdentifier,
